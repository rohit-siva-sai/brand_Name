        ...
        <div className="flex flex-col space-y-8 items-center pt-10">
          <div className="flex items-center space-x-4 bg-white pl-4 py-4 rounded-xl shadow-md w-3/5">
            ...
            <div>
              ...
              <p className="font-bold">{profileUser?.username && profileUser?.username }</p>
            </div>
          </div>
          <div className="flex flex-col shadow-md rounded-xl dividea-y-2 space-y-2   bg-white p-2 w-3/5">
            <div className="flex items-center space-x-5 py-2 cursor-pointer  hover:bg-gray-100 rounded-lg  pl-6">
              <MdLocationOn className="text-blue-500 text-3xl" />
              <p className="font-bold text-blue-500">My Address</p>
            </div>
            <div className="flex items-center    space-x-5 py-2 cursor-pointer  hover:bg-gray-100 rounded-lg border-t pl-6">
              <MdShoppingBag className="text-gray-500 text-3xl" />
              <p className="font-bold text-gray-500">My Orders</p>
            </div>
            <div className="flex  items-center space-x-5 hover:bg-gray-100 cursor-pointer rounded-lg py-3 border-t pl-6">
              <FcLikePlaceholder className="text-gray-500 text-2xl" />
              <p className="font-bold text-gray-500">My Wishlist</p>
            </div>
          </div>
        </div>
      </div>
