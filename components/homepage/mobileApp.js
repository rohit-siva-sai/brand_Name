...
const MobileApp = () => {
  return (
    <div >
      <div className="grid grid-cols-2 h-[630px] mb-6   align-middle ">
        {/* <Model/> */}
        <div className="flex justify-end relative   items-center">
          <div
            className="h-5/6 w-2/6 border-8 relative shadow-[0px_0px_2px_1px] shadow-gray-700  rounded-[50px] bg-cover bg-no-repeat border-gray-800"
            style={{
          ...
          <div
            className="h-5/6 w-2/6 border-8 relative top-16 -left-16 shadow-[0px_0px_2px_1px] shadow-gray-700  rounded-[50px] bg-cover bg-no-repeat border-gray-800"
            style={{
        ...
        <div className="flex flex-col justify-center pl-8 space-y-6 ">
          <p className="font-bold text-4xl w-3/5 ">
            Builder Oriented Services & Accurate Services
          </p>
          <p className="font-semibold text-base w-1/2 text-gray-500">
