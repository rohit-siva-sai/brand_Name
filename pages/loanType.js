...
const LoanType = () => {
  ...
  const [loanType,updateLoanType] = useLoans((store)=> [store.loanType,store.updateLoanType])
  const updateIncreaseProgress = useLoans((store)=>store.updateIncreaseProgress)
